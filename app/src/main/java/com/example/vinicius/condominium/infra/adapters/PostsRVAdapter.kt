...
class PostsRVAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(post.tipo == "ocorrencia")
            holder.itemView.timeline.setMarker(VectorDrawableUtils.getDrawable(context,R.drawable.ic_sms_failed_black_24dp))
        else holder.itemView.timeline.setMarker(VectorDrawableUtils.getDrawable(context,R.drawable.ic_input_black_24dp))
